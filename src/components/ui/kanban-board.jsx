...
export default function KanbanBoard() {
  ...
  const itemsData = {
    "1": { id: "1", title: "Aterro", equipe: "05", dias: "27/03 - 29/04", valor: "R$ 6.000,00" },
    "2": { id: "2", title: "Escreva o serviço", equipe: "Equipe A", dias: "27/01 - 29/01", valor: "R$ 6.000,00" },
    "3": { id: "3", title: "Serviço em andamento", equipe: "Equipe B", dias: "27/01 - 29/01", valor: "R$ 6.000,00" },
    "4": { id: "4", title: "Finalizado", equipe: "Equipe C", dias: "27/01 - 29/01", valor: "R$ 6.000,00" },
  };
  ...
  const onDragEnd = ({ active, over }) => {
    ...
    const toColumnId = Object.keys(columnsState).find((col) =>
      ...
      <div className="flex gap-6 p-6 overflow-x-auto w-full items-start">
        {Object.entries(columnsState).map(([columnId, column]) => (
          ...
          >
            ...
            <button className="mt-4 text-sm text-blue-600 hover:underline">+ Novo Cartão</button>
          </div>
        ))}
      </div>
    </DndContext>
